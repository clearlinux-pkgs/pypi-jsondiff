...
Source0  : https://files.pythonhosted.org/packages/35/48/841137f1843fa215ea284834d1514b8e9e20962bda63a636c7417e02f8fb/jsondiff-2.2.1.tar.gz
...
%prep
%setup -q -n jsondiff-2.2.1
cd %{_builddir}/jsondiff-2.2.1
pushd ..
cp -a jsondiff-2.2.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1724941250
