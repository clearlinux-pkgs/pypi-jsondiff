...
Source0  : https://files.pythonhosted.org/packages/9e/c4/efc93ce3c13daeeacd39c98f9b9b720bea85b2970282553a2aad07cf5b01/jsondiff-2.1.1.tar.gz
...
%prep
%setup -q -n jsondiff-2.1.1
cd %{_builddir}/jsondiff-2.1.1
pushd ..
cp -a jsondiff-2.1.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1720053660
