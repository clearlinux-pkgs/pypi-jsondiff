...
Source0  : https://files.pythonhosted.org/packages/21/c6/57158093587de0ab578da6f27467e00b037d63b3538204fc27860d427144/jsondiff-1.3.1.tar.gz
...
%prep
%setup -q -n jsondiff-1.3.1
cd %{_builddir}/jsondiff-1.3.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1643042329
...
cp %{_builddir}/jsondiff-1.3.1/LICENSE %{buildroot}/usr/share/package-licenses/pypi-jsondiff/0439ac90b9812d0e46a14b9bc0d1a4fcbee071f6
