...
Source0  : https://files.pythonhosted.org/packages/f0/7f/bdcfaa610565d05eb0adf28f497761f8d7f4f4089af5adafaf377ff0c45b/jsondiff-2.1.2.tar.gz
...
%prep
%setup -q -n jsondiff-2.1.2
cd %{_builddir}/jsondiff-2.1.2
pushd ..
cp -a jsondiff-2.1.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1721061743
